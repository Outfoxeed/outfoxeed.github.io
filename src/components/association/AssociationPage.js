        ...
        <ul className="content-container">
          <li className="content-row">
            <div className="content-text-container">
              <p>I have been for two years the vice president of <a href="https://linktr.ee/leoindiegames" target="_blank" rel="noreferrer">Léo Indie Games</a>, a student association about the video game industry and game development in the Léonard de Vinci University pole.</p>
          ...
          <li className="content-row">
            <div className="content-text-container">
              ...
              <p>
                2021: two teams of the association won a prize including my team with a game named <a href="https://growparishmeridian.itch.io/beat-polarity" target="_blank" rel="noreferrer">'Beat Polarity'</a>
                <br/>
